...
class Trainer:
    ...
    def run_experiment(self, train_iter, val_iter, test_iter=None, epochs=10, lr=1e-3, name="Experiment", hyperparameters=None, save_weights=False):
        ...
        for epoch in range(epochs):  # Use standard range if not using tqdm for epoch loop specifically, or wrap here
    ...
    def print_experiment_summary(self, name, total_time, num_params, hyperparameters, history, test_loss=None, test_acc=None):
        """
